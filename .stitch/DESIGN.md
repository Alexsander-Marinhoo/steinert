...
### Componentes Sugeridos (Contexto Dental)
*   **Before/After Slider:** Um componente minimalista para comparar resultados de tratamentos, essencial para construir confiança.
*   **Timeline de Tratamento:** Um fluxo vertical que utiliza círculos preenchidos com `primary` e linhas em `outline-variant` (20% opacidade) para explicar etapas de procedimentos complexos.
...
### Do (Fazer)
*   **Use White Space como Luxo:** Deixe o conteúdo respirar. O espaço vazio é o que diferencia uma clínica popular de uma clínica boutique.
*   **Imagens de Alta Qualidade:** Use fotografias com profundidade de campo (fundo desfocado) e luz natural.
*   **Alinhamento Assimétrico:** Posicione textos à esquerda enquanto imagens equilibram o peso à direita, permitindo que o olhar escaneie a página de forma fluida.

### Don't (Não Fazer)
*   **Não use Azul "Médico" Genérico:** Evite o azul ciano ou tons muito claros que lembram hospitais públicos. Mantenha-se no Navy profundo.
*   **Não sature com ícones:** Use ícones apenas quando necessário. A tipografia deve ser a protagonista da comunicação.
*   **Evite cantos vivos:** Cantos de 90 graus transmitem rigidez e agressividade. Utilize a escala de `roundedness` para suavizar a experiência.
*   **Zero Grids Rígidos:** Não force todos os elementos a terem a mesma largura. Permita que elementos de destaque (como o Hero) ocupem mais espaço visual do que os blocos de texto secundários.

---
**Idioma do Sistema:** Português (PT-BR)
**Tom de Voz:** Profissional, Calmo, Autoritário e Sofisticado.
